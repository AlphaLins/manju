...
import u from "@/utils";
import OutlineScript from "@/agents/poetryOutlineScript";
...
router.ws("/", async (ws, req) => {
  ...
  ws.on("message", async function (rawData: string) {
    ...
    console.log("[poetry_outline/agentsOutline.ts] ProjectID:", projectId, "Fetched t_poetry_novel length:", novelData.length, novelData);
  ...
  async function saveHistory() {
    ...
    if (existing) {
      ...
      await u.db("t_poetry_chatHistory").insert({
