      ...
      <div class="about">
        <a-card title="关于" style="width: 100%">
          <div class="aboutData">
            <div class="aboutInfo">
              <div class="aboutLogo">
                <img src="@/assets/logo.png" alt="Cosmos Logo" class="logoImg" />
                <div class="appInfo">
                  <h2 class="appName">Cosmos</h2>
                  <span class="appVersion">v1.0.6</span>
                </div>
              </div>
              <p class="aboutDesc">Cosmos 是一款开源的 AI 驱动漫画/分镜创作工具，帮助创作者快速生成故事分镜和视频内容。</p>
...
const GITHUB_URL = "https://github.com/HBAI-Ltd/Cosmos-app";
const GITEE_URL = "https://gitee.com/HBAI-Ltd/Cosmos-app";
