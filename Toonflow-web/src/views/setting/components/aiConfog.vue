...
function startConfig(item: ModelType) {
  ...
  const imageKey = ["editImage", "storyboardImage", "assetsImage", "poetryEditImage", "poetryStoryboardImage", "poetryAssetsImage"];
  const textKey = ["storyboardAgent", "outlineScriptAgent", "assetsPrompt", "generateScript", "videoPrompt", "poetryStoryboardAgent", "poetryOutlineScriptAgent", "poetryAssetsPrompt", "poetryGenerateScript", "poetryVideoPrompt"];
