  ...
  <div class="aboutPage">
    <t-card class="logoCard">
      <div class="logoSection">
        <img src="@/assets/logo.png" alt="Cosmos Logo" class="logo" />
        <h2 class="appName">Cosmos</h2>
    ...
    <t-card class="linkCard">
      <div class="linkItem" @click="openLink('https://github.com/HBAI-Ltd/Cosmos-app')">
        <i-github theme="outline" size="20" />
        <span>GitHub 仓库</span>
        <i-right theme="outline" size="16" class="arrow" />
      </div>
      <t-divider />
      <div class="linkItem" @click="openLink('https://gitee.com/HBAI-Ltd/Cosmos-app')">
    ...
    <t-card class="linkCard">
      <div class="linkItem" @click="openLink('https://github.com/HBAI-Ltd/Cosmos-app/releases')">
        <i-refresh theme="outline" size="20" />
        <span>检查更新 (GitHub)</span>
        <i-right theme="outline" size="16" class="arrow" />
      </div>
      <t-divider />
      <div class="linkItem" @click="openLink('https://gitee.com/HBAI-Ltd/Cosmos-app/releases')">
        <i-refresh theme="outline" size="20" />
